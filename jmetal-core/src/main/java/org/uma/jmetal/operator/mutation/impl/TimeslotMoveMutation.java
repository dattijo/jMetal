 ...
 * @param <T>
 */
public class TimeslotMoveMutation<T> implements MutationOperator<IntegerMatrixSolution<T>> {   
    ...
    public TimeslotMoveMutation(double mutationProbability, int timeslots) {
     ...
     * @param timeslots
     */
    public TimeslotMoveMutation(double mutationProbability, RandomGenerator<Double> mutationRandomGenerator,
...
//                System.out.println("\n\nNEW SOLUTION");
                ...
                int randTimeslotIndex2 = freeTimeslots.get(positionRandomGenerator.getRandomValue(0, freeTimeslots.size() - 1));
...
//                System.out.println("Timeslot 2 = "+randTimeslotIndex2);
                while (randTimeslotIndex1 == randTimeslotIndex2) {
                    if (randTimeslotIndex1 == (solutionLength - 1)) {                        
                        randTimeslotIndex2 = freeTimeslots.get(positionRandomGenerator.getRandomValue(0, freeTimeslots.size() - 2));
                    } else {                        
                        randTimeslotIndex2 = freeTimeslots.get(positionRandomGenerator.getRandomValue(0, freeTimeslots.size() - 1));
                    }
                }                                      
